...
from feature_extraction.FFT.FFTFeatures import obtain_concatenate_segments_fft, \
...
from utils.DataSpliting import train_test_doa_balanced_on_train_on_test, obtain_A_features_from_doa_check_bursts
...
# print(
#     '################################################ L1D2 remove_burst ################################################################')
# csv_file_2 = "svm_L1D2_M014_remove_burst_FFT.csv"
# csv_results_2 = "svm_L1D2_M014_remove_burst_FFT_avr.csv"
#
# output_name_2 = "classification_svm_L1D2_M014_remove_burst_FFT.txt"
# output_file_2 = open(output_name_2, 'w')
#
# output_file_2.write("Classify bt 2 levels remove_burst and mark\n")
...
# ######################################################  L1D2M3 remove_burst_FFTv ##########################################
# print(
#     '################################################ L1D2M3 remove_burst ################################################################')
# csv_file_3 = "svm_L1D2M3_M014_remove_burst_FFT.csv"
# csv_results_3 = "svm_L1D2M3_M014_remove_burst_FFT_avr.csv"
#
# output_name_3 = "classification_svm_L1D2M3_M014_remove_burst_FFT.txt"
# output_file_3 = open(output_name_3, 'w')
#
# output_file_3.write("Classify bt 3 levels, remove_burst and  mark \n")
# output_file_3.write("LIGHT1 DEEP2 MEDIUM3  spon_Stim concat only FFT descriptors \n")
...
csv_file_4 = "svm_L1D2_M014_remove_burst_FFT_TESPAR_A.csv"
csv_results_4 = "svm_L1D2_M014_remove_burst_FFT_TESPAR_A_avr.csv"

output_name_4 = "classification_svm_L1D2_M014_remove_burst_FFT_TESPAR_A.txt"
output_file_4 = open(output_name_4, 'w')

output_file_4.write("Classify bt 2 levels remove_burst and mark \n")
...
print(
    '############################################### L1D2 remove_burst  ################################################################')
csv_file_4 = "svm_L1D2_M014_remove_burst.csv"
csv_results_4 = "svm_L1D2_M014_remove_burst_avr.csv"

output_name_4 = "classification_svm_L1D2_M014_remove_burst.txt"
output_file_4 = open(output_name_4, 'w')

output_file_4.write("Classify bt 2 levels remove_burst, and mark \n")
output_file_4.write("LIGHT1 DEEP2 spon_Stim concat TESPAR A \n")
output_file_4.write("train_test_doa_balanced_on_train_on_test 80% for train \n")
...
print(
    '################################################ L1D2M3 remove burst ################################################################')
csv_file = "svm_L1D2M3_M014_remove_burst.csv"
csv_results = "svm_L1D2M3_M014_remove_burst_avr.csv"

output_name_1 = "classification_svm_L1D2M3_M014_remove_burst.txt"
output_file_1 = open(output_name_1, 'w')

output_file_1.write("Classify bt3 levels, remove_burst and mark\n")
output_file_1.write("deep2 light4  stim_spon TESPAR A \n")
output_file_1.write("train_test_doa_balanced_on_train_on_test 80% for train \n")
