...
csv_file = "svm_20_deep12_medium35_2segs.csv"
# csv_results = "svm_20_deep12_medium35_2segs_avr.csv"

output_name = "results_svm_20_deep12_medium35_2segs.txt"
output_file = open(output_name, 'w')

output_file.write("Classify bt 2 levels, before filtering and without marking bursts 30 apr \n")
...
initialization_test = InitDataSet(current_directory=data_dir, subject_directory="m014", filtering_directory="classic",
                             levels=levels_test)
