...
csv_file = "svm_first_3classes_M014_classic.csv"
csv_results = "svm_first_3classes_M014_classic_avr.csv"

output_name = "classification_svm_first_3classes_M014_classic.txt"
output_file = open(output_name, 'w')

output_file.write("Classify bt classic first 3 levels, classic and without marking bursts\n")
output_file.write("LIGHT1, DEEP2, MEDIUM3 A matrix alphabet3 most common\n")
