...
from utils.DataSpliting import train_test_doa_check_trials, obtain_A_features_from_doa, train_test_doa_remake_balanced
...
output_file.write("DEEP MEDIUM A matrix \n")
