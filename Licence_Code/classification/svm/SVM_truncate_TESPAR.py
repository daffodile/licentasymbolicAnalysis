...
from tests.Tespar.Encoding_before_checking_bursts import EncodingBeforeNoBursts
from utils.DataSpliting_master import obtain_features_labels, train_test_doa

'''
    to change  this files
'''
csv_file = "svm_truncate_A.csv"
csv_results = "svm_truncate_A_avr.csv"
...
encoding = EncodingBeforeNoBursts('./../../data_to_be_saved/alphabet_3.txt')
