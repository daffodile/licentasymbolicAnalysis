...
csv_file = "svm_remove_burst_deep9_light11_M016.csv"
csv_results = "svm_remove_burst_deep9_light11_M016_avr.csv"

classification_reports = "classification_reports_svm_remove_burst_deep9_light11_M016.txt"
output_classification_reports = open(classification_reports, 'w')

confusion_file = 'confusion_matrix_remove_burst_deep9light11.txt'
output_confusion_matrix = open(confusion_file, 'w')

output_classification_reports.write(
    "Classify bt DEEP9 and LIGHT11:  classic and with REMOVE burstung trials, skip burst symbols \n")
output_classification_reports.write("spon_stim concatenate A matrix 32 symbols obtained on all classic data\n")
...
encoding = EncodingCheckBursts('./../../data_to_be_saved/32alphabet_s3_classic_m016_full.txt')

data_dir = os.path.join('..', '..')

levels = ['deep9', 'light11']
initialization_train = InitDataSetWithBurstsFlags(current_directory=data_dir, subject_directory="m016", filtering_directory="classic",
                                   levels=levels)
