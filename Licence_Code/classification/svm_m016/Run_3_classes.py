...
csv_file = "svm_classic_3classes_all.csv"
csv_results = "svm_classic_3classes_avr.csv"

classification_reports = "classification_reports_svm_classic_3classes.txt"
output_classification_reports = open(classification_reports, 'w')

confusion_file = 'confusion_matrix_svm_classic_3classes.txt'
output_confusion_matrix = open(confusion_file, 'w')

output_classification_reports.write(
    "Classify 3 classes:  DEEP6, LIGHT7, MEDIUM8:  classic, no remove no marking \n")
