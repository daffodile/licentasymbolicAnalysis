...
csv_file = "svm_classic_deep6_light7_M016.csv"
csv_results = "svm_classic_deep6_light7_M016_avr.csv"

classification_reports = "classification_reports_svm_classic_deep6_light17_M016.txt"
output_classification_reports = open(classification_reports, 'w')

confusion_file = 'confusion_matrix_hp10_deep6light7.txt'
output_confusion_matrix = open(confusion_file, 'w')

output_classification_reports.write(
    "Classify bt DEEP6 and LIGH7:  classic and NO remove no marking \n")
