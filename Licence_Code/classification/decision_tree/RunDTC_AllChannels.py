...
from classification.decision_tree.old.Old_Obtain_Features import train_test_doa, obtain_features_labels
...
csv_file = "dtc_30_all_32.csv"
csv_results = "dtc_30_avg_all_32.csv"
# open file to write the indices of  each splitting
indexes_file = "dtc_30_all_32.txt"
...
initialization = InitDataSet(trials_to_skip=[1])
