...
csv_file_1 = "svm_per_seg_L1M5_M014_classic.csv"
csv_results_1 = "svm_per_seg_L1M5_M014_classic_avr.csv"

output_name = "classification_svm_per_seg_L1M5_M014_classic.txt"
output_file = open(output_name, 'w')

output_file.write("Classify bt 2 levels, classic without marking bursts\n")
output_file.write("LIGHT1 MEDIUM5 a single segment A matrix \n")
...
csv_file_2 = "svm_ephasize_stim_L1M5_M014_classic.csv"
csv_results_2 = "svm_ephasize_stim_L1M5_M014_classic_avr.csv"

output_name = "classification_svm_ephasize_stim_L1M5_m014_classic_avr.txt"
output_file = open(output_name, 'w')

output_file.write("Classify bt 2 levels, classic without marking bursts\n")
output_file.write("LIGHT1  MEDIUM5 emphasize stimulus =  A matrix \n")
output_file.write("train_test_doa_remake_balanced 80% for train \n")
