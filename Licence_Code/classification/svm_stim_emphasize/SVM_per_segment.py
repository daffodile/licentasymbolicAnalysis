...
csv_file_1 = "svm_per_seg_D2L4_M014_remove_bursts.csv"
csv_results_1 = "svm_per_seg_D2L4_M014_remove_bursts_avr.csv"

output_name = "classification_svm_per_seg_D2L4_M014_remove_bursts.txt"
output_file = open(output_name, 'w')

output_file.write("Classify bt 2 levels,  classic with mark and remove bursts\n")
output_file.write("DEEP2 LIGHT4 a single segment A matrix \n")
...
csv_file_2 = "svm_ephasize_stim_D2L4_M014_remove_bursts.csv"
csv_results_2 = "svm_ephasize_stim_D2L4_M014_remove_bursts_avr.csv"

output_name = "classification_svm_ephasize_stim_D2L4_m014_remove_bursts_avr.txt"
output_file = open(output_name, 'w')

output_file.write("Classify bt 2 levels, classic with mark and remove bursts\n")
output_file.write("DEEP2 LIGHT4 emphasize stimulus =  A matrix \n")
output_file.write("train_test_doa_remake_balanced 80% for train \n")
