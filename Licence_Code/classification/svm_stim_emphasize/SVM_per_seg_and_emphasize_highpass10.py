...
encoding = Encoding('./../../data_to_be_saved/32alphabet5_hp10_m014.txt', no_symbols=32)
...
csv_file_1 = "svm_per_seg_L1D2_M014_highpass10.csv"
csv_results_1 = "svm_per_seg_L1D2_M014_highpass10_avr.csv"

output_name = "classification_svm_per_seg_L1D2_M014_highpass10.txt"
output_file = open(output_name, 'w')

output_file.write("Classify bt 2 levels, filtered with highpass 10 without marking bursts\n")
...
csv_file_2 = "svm_ephasize_stim_L1D2_M014_highpass10.csv"
csv_results_2 = "svm_ephasize_stim_L1D2_M014_highpass10_avr.csv"

output_name = "classification_svm_ephasize_stim_L1D2_m014_highpass10_avr.txt"
output_file = open(output_name, 'w')

output_file.write("Classify bt 2 levels,filtered with highpass10 without marking bursts\n")
