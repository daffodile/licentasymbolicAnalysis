...
print(
    '################################################ L2D3 ################################################################')
csv_file = "svm_L2D3_M013_classic.csv"
csv_results = "svm_L2D3_M013_classic_avr.csv"

output_name_1 = "classification_svm_L2D3_M013_classic.txt"
output_file_1 = open(output_name_1, 'w')

output_file_1.write("Classify bt 2 levels, classic, without marking bursts\n")
...
print(
    '################################################ L2D6 ################################################################')
csv_file_2 = "svm_L2D6_M013_classic.csv"
csv_results_2 = "svm_L2D6_M013_classic_avr.csv"

output_name_2 = "classification_svm_L2D6_M013_classic.txt"
output_file_2 = open(output_name_2, 'w')

output_file_2.write("Classify bt 2 levels, classic, without marking bursts\n")
...
print(
    '################################################ D3L4 ################################################################')
csv_file_3 = "svm_D3L4_M013_classic.csv"
csv_results_3 = "svm_D3L4_M013_classic_avr.csv"

output_name_3 = "classification_svm_D3L4_M013_classic.txt"
output_file_3 = open(output_name_3, 'w')

output_file_3.write("Classify bt 2 levels, classic, without marking bursts\n")
...
print(
    '################################################ L4D6 ################################################################')
csv_file_4 = "svm_L4D6_M013_classic.csv"
csv_results_4 = "svm_L4D6_M013_classic_avr.csv"

output_name_4 = "classification_svm_L4D6_M013_classic.txt"
output_file_4 = open(output_name_4, 'w')

output_file_4.write("Classify bt 2 levels, classic, without marking bursts\n")
