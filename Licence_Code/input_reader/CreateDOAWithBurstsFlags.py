'''
    CreateDOA as befor but now use SegmentWithBurstsFlags model instead Models.Segment
'''
import os
import numpy as np
...
from models.SegmentWithBurstsFlags import SegmentWithBurstsFlags


class CreateDOAWithBurstsFlags:
        ...
        for i in range(self.reader_epd.no_channels):
            ...
            for j in range(self.reader_eti.no_trials):
                if self.reader_eti.trials_description['Error'][j] != 1:
                    ...
                    seg_spontaneous = SegmentWithBurstsFlags(timestamp_spontaneous, timestamp_stimulus,
                    ...
                    seg_stimulus = SegmentWithBurstsFlags(timestamp_stimulus, timestamp_poststimulus, code_stimulus,
                                                          code_poststimulus)
                    ...
                    seg_poststimulus = SegmentWithBurstsFlags(timestamp_poststimulus, timestamp_end_poststimulus,
