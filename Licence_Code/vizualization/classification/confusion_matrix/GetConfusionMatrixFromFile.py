...
# print('SVM classic 2 classes ')
# svm_classic = 'results_svm_deep1vs2.txt'
# m, sd = get_mean_and_std_dev_confusion_matrix_from_results_file_total(svm_classic, (2, 2), lines_begin=4,
#                                                                       lines_inter_results=8)
# plot_confusion_matrix(m, 'SVM classic', labels=['light1', 'deep2'])
# plot_confusion_mat_and_std(m, sd, 'SVM classic 2 classes', labels=['light1', 'deep2'])
# print(m)
# print(sd)
#
# print('SVM highpass 2 classes ')
# svm_classic = 'classification_svm_deep1_deep2_M014_highpass10.txt'
# m, sd = get_mean_and_std_dev_confusion_matrix_from_results_file_total(svm_classic, (2, 2), lines_begin=4,
#                                                                       lines_inter_results=8)
# plot_confusion_matrix(m, 'SVM classic', labels=['light1', 'deep2'])
# plot_confusion_mat_and_std(m, sd, 'SVM classic 2 classes', labels=['light1', 'deep2'])
...
# how to call function
print('SVM classic ')
svm_classic = 'confusion_matrix_classic_5classes.txt'
m, sd = get_mean_and_std_dev_confusion_matrix_total(svm_classic, (5, 5))
plot_confusion_matrix(m, 'SVM classic', labels=['light1', 'deep2', 'light4', 'medium3', 'medium5']
                      )
plot_confusion_mat_and_std(m, sd, 'SVM classic', labels=['light1', 'deep2', 'light4', 'medium3', 'medium5']
                           )
print(m)
print(sd)

print('SVM REMOVE BURSTS 10')
svm_HP10 = 'classification_svm_5classes_M014_remove_bursts.txt'
m1, sd1 = get_mean_and_std_dev_confusion_matrix_from_results_file_total(svm_HP10, (5, 5), lines_begin=3,
                                                                        lines_inter_results=11)
plot_confusion_matrix(m1, 'SVM highpass10 filter', labels=['light1', 'deep2', 'light4', 'medium3', 'medium5']
                      )
plot_confusion_mat_and_std(m1, sd1, 'SVM highpass10 filter', labels=['light1', 'deep2', 'light4', 'medium3', 'medium5']
                           )
print(m1)
print(sd1)

print('SVM HIGH PASS 10')
svm_HP10 = 'confusion_matrix_hp10_5classes.txt'
m2, sd2 = get_mean_and_std_dev_confusion_matrix_total(svm_HP10, (5, 5))
plot_confusion_matrix(m2, 'SVM highpass10 filter', labels=['light1', 'deep2', 'light4', 'medium3', 'medium5']
                      )
plot_confusion_mat_and_std(m2, sd2, 'SVM highpass10 filter', labels=['light1', 'deep2', 'light4', 'medium3', 'medium5']
                           )
print(m2)
print(sd2)
