...
thresholds_m013 = {'2': [-8.817258834838867, 8.704358100891113], '3': [-13.665229797363281, 14.236004829406738],
                   '4': [-23.46617889404297, 24.52109718322754], '5': [-13.622994422912598, 14.20591926574707],
                   '6': [-8.841586112976074, 8.730076789855957], '7': [-13.649242401123047, 14.22615909576416],
                   '8': [-23.8541259765625, 24.922597885131836], '9': [-32.20914077758789, 34.059783935546875],
                   '10': [-14.127691268920898, 14.733710289001465], '11': [-14.21212100982666, 14.826313018798828],
                   '12': [-13.734461784362793, 14.329936027526855], '13': [-10.87215805053711, 10.883581161499023],
                   '14': [-26.55008316040039, 28.15007781982422], '15': [-16.751413345336914, 17.00990867614746],
                   '16': [-37.15553665161133, 39.35347366333008], '17': [-9.315095901489258, 9.143726348876953],
                   '18': [-31.111774444580078, 32.74834060668945], '19': [-10.800679206848145, 10.565116882324219],
                   '20': [-12.431575775146484, 12.159488677978516], '21': [-11.044426918029785, 10.781229019165039],
                   '23': [-10.07295036315918, 9.871413230895996], '24': [-10.147063255310059, 9.936002731323242],
                   '25': [-10.240405082702637, 10.265402793884277], '26': [-9.773699760437012, 9.52276611328125],
                   '27': [-9.78455638885498, 9.805434226989746], '28': [-9.945527076721191, 9.69575023651123],
                   '29': [-9.888143539428711, 9.908184051513672], '30': [-21.70805549621582, 22.127086639404297],
                   '31': [-9.126808166503906, 8.95895767211914], '32': [-26.85137939453125, 28.155065536499023]}

inter_bursts_m013 = 410


def mark_bursts_regions(doas, subject='m014',
    ...
    '''
    thresholds = dict
    max_interbursts_dist = 0
    if subject == 'm014':
        thresholds = thresholds_m014
        max_interbursts_dist = inter_bursts_m014
    if subject == 'm016':
        thresholds = thresholds_m016
        max_interbursts_dist = inter_bursts_m016
    if subject == 'm013':
        thresholds = thresholds_m013
        max_interbursts_dist = inter_bursts_m013
